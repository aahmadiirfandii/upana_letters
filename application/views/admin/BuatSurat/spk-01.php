			...
			<div class="main">
				<div class="main-content">
					...
					<div class="container-fluid">
						<form action="<?php echo base_url(); ?>admin/BuatSurat/cek_surat" method="post">
						<div class="panel">
									...
									<div class="panel-body">
										<div class="box">
											...
											<div class="box-forms">
												...
												<br>
												<strong><?php if($this->uri->segment(3) == "SPK01")
														{
															echo "SURAT KESEPAKTAN KERJA";
														}
										...
										{
											require_once 'suratspk1.php';
										}
										elseif ($this->uri->segment(3) == "SPK02")
										{
											require_once 'suratspk2.php';
										}
										elseif ($this->uri->segment(3) == "INV")
										{
