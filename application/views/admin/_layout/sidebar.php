					...
					<ul class="nav" id="sidebar-nav-menu">
						...
						<li class="panel">
							...
							<div id="dashboards" class="collapse ">
								<ul class="submenu">
									<li><a href="<?php echo base_url('admin/ProsesKerjaPraktek'); ?>" class="<?php echo ($act=='ProsesKerjaPraktek')?'active':'';?>" >Surat Invoice</a></li>
									<li><a href="<?php echo base_url('admin/ProsesAktifKuliah'); ?>" class="<?php echo ($act=='ProsesAktifKuliah')?'active':'';?>" >Surat Perjanjian Kerja</a></li>
									<li><a href="<?php echo base_url('admin/ProsesIzinPenelitian'); ?>" class="<?php echo ($act=='ProsesIzinPenelitian')?'active':'';?>" >Surat Perjanjian Kerja Pekerja Lepas</a></li>
								</ul>
							</div>
						</li>
						<li class="panel">
							<a href="#layouts" data-toggle="collapse" data-parent="#sidebar-nav-menu" class="<?php echo ($act==('Invoice') or $act==('SPK01') or $act==('SPK02'))?'collapsed active':'';?>"><i class="ti-layout-grid2"></i> <span class="title">Arsip Surat</span> <i class="icon-submenu ti-angle-left"></i></a>
